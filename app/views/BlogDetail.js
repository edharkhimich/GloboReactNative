...
export class BlogDetail extends React.Component {
    ...
    componentDidMount() {
        ...
        return fetch(`https://public-api.wordpress.com/rest/v1.1/sites/kdevdotgroup.wordpress.com/posts/${blogId}`)
    ...
    render() {
        ...
        const blogClassStyles = {
            blTitle: { marginLeft: 'auto', marhinRight: 'auto' },
